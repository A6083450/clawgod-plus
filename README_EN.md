...
The installer scripts are deterministic generated artifacts: `src/` is the single source of truth, and `install.sh` plus `install.ps1` are generated by `bun build.mjs` — do not edit them by hand.
